...
namespace board
{
  inline constexpr SysClockConfig sys_cfg_84{
  ...
  {
    /* Configure Uart2 Pin */
    inline constexpr GPIO_Config gpio_cfg{
    ...
    inline constexpr DMA_Config hdmatx_cfg{
      .Peripheral = DMA_Peripheral::USART2_TX,
    ...
    inline constexpr DMA_Config hdmarx_cfg{
      .Peripheral = DMA_Peripheral::USART2_RX,
      .Device = DMA_Device::DMA_D1,
  ...
  namespace spi1
  {
    ...
    /* SPI */
    inline constexpr Stm32Spi::Config cfg{
      .dev = Stm32Spi::SpiDev::SPI_D1,
  ...
  namespace exti
  {
    ...
    inline constexpr GPIO_Config pc13_gpio_cfg{
      .pin = GPIO_PIN_13,
  ...
  namespace tim3
  {
    inline constexpr TimerConfig cfg{
      .Instance = TimerDevice_t::TIMER_3,
