...
enum class UartState_t : uint8_t {
	Reset,
	Ready,
	BusyTx,
	BusyRx,
...
enum class UartError_t : uint8_t {
	None,
	Timeout,
	Framing,
	Overrun,
...
enum class UartDevice_t : uint8_t {
	USART_D1,
	USART_D2,
	USART_D6,
	USART_COUNT
...
enum class UartBaudRate_t : uint32_t {
	BR_9600 = 9600,
	BR_115200 = 115200,
	BR_460800 = 460800,
	BR_921600 = 921600
...
enum class UartComm_t : uint8_t {
	RX_ONLY,
	TX_ONLY,
	RX_TX
};

enum class UartParity_t : uint8_t {
	NONE,
	EVEN,
	ODD
};

enum class UartStopBit_t : uint8_t {
	USART_CR2_STOP_1 = 0x00U,
	USART_CR2_STOP_2 = 0x10U
};
