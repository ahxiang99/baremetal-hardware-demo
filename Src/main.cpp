...
extern "C" void HardFault_Handler(void)
{
	...
	volatile uint32_t hfsr =
		*reinterpret_cast<volatile uint32_t *>(0xE000ED2C); // Hard Fault Status
	volatile uint32_t cfsr =
		*reinterpret_cast<volatile uint32_t *>(0xE000ED28); // Configurable Fault Status
	volatile uint32_t bfar =
		*reinterpret_cast<volatile uint32_t *>(0xE000ED38); // Bus Fault Address
	volatile uint32_t mmar =
		*reinterpret_cast<volatile uint32_t *>(0xE000ED34); // MemManage Fault Address
