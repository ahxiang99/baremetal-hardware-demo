...
static const AppMode_Table namingTable[static_cast<uint8_t>(AppMode::COUNT)] = {
    {AppMode::SendPacket, "Packet Mode" },
    {AppMode::Console,    "Console Mode"},
    {AppMode::CliMode,    "CLI Mode"    }
};
