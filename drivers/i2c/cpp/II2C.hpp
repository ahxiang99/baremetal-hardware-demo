...
struct I2C_Ref {
    ...
    using i2c_process_rx_fn = void (*)(void *ctx);
    ...
    i2c_process_rx_fn process_rx_fn{nullptr};

  public:
    template <I2C_Device T> static I2C_Ref from(T &dev)
    {
	I2C_Ref ref;
	ref.ctx = &dev;
	...
	ref.process_rx_fn = [](void *ctx) { return static_cast<T *>(ctx)->processRx(); };
	return ref;
    }
