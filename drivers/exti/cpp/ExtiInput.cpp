...
static const Exti_Table exti_gpio_table[GPIO_PIN_COUNT]{
	{GPIO_PIN_0, &SYSCFG_PTR->EXTICR1, EXTI0_IRQn, 0},       {GPIO_PIN_1, &SYSCFG_PTR->EXTICR1, EXTI1_IRQn, 4},      {GPIO_PIN_2, &SYSCFG_PTR->EXTICR1, EXTI2_IRQn, 8},
	{GPIO_PIN_3, &SYSCFG_PTR->EXTICR1, EXTI3_IRQn, 12},      {GPIO_PIN_4, &SYSCFG_PTR->EXTICR2, EXTI4_IRQn, 0},      {GPIO_PIN_5, &SYSCFG_PTR->EXTICR2, EXTI9_5_IRQn, 4},
	{GPIO_PIN_6, &SYSCFG_PTR->EXTICR2, EXTI9_5_IRQn, 8},     {GPIO_PIN_7, &SYSCFG_PTR->EXTICR2, EXTI9_5_IRQn, 12},   {GPIO_PIN_8, &SYSCFG_PTR->EXTICR3, EXTI9_5_IRQn, 0},
	{GPIO_PIN_9, &SYSCFG_PTR->EXTICR3, EXTI9_5_IRQn, 4},     {GPIO_PIN_10, &SYSCFG_PTR->EXTICR3, EXTI15_10_IRQn, 8}, {GPIO_PIN_11, &SYSCFG_PTR->EXTICR3, EXTI15_10_IRQn, 12},
	{GPIO_PIN_12, &SYSCFG_PTR->EXTICR4, EXTI15_10_IRQn, 0},  {GPIO_PIN_13, &SYSCFG_PTR->EXTICR4, EXTI15_10_IRQn, 4}, {GPIO_PIN_14, &SYSCFG_PTR->EXTICR4, EXTI15_10_IRQn, 8},
...
Result<> ExtiInput::initialize(const GPIO_Config &config, ExtiFn fn, void *ctx)
{
