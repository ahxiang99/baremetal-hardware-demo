...
enum class TimerState_t : uint8_t {
	Reset,
	Stopped,
	Running,
	Expired,
...
enum class TimerDevice_t : uint8_t {
	TIMER_1,
	TIMER_2,
	TIMER_3,
	TIMER_4,
...
enum class TimerCenterAlignedMode_t : uint8_t {
	EDGE,
	CENTER_MODE_1,
	CENTER_MODE_2,
	CENTER_MODE_3
};
enum class TimerDirection_t : uint8_t {
	UP,
	DOWN
};
enum class TimerClockDivision_t : uint16_t {
	TIM_CLOCKDIVISION_DIV1 = (0 << 8),
	TIM_CLOCKDIVISION_DIV2 = (1 << 8),
	TIM_CLOCKDIVISION_DIV4 = (2 << 8)
};
enum class TimerARR_t : uint8_t {
	DISABLE,
	ENABLE
};
...
class Stm32Timer
{
	...
	[[nodiscard]] TIM_TypeDef *getInstance() const;
